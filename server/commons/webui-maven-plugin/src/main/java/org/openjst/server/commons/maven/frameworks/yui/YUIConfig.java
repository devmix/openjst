...
final class YUIConfig {
    ...
    private final Map<String, YUIGroup> groups = new LinkedHashMap<String, YUIGroup>();
    ...
    public YUIGroup addGroup(final String name, final String comboBase,
                             final boolean combine, final String filter) {
        final YUIGroup group = new YUIGroup(comboBase, combine, filter);
    ...
    public Map<String, YUIGroup> getGroups() {
        return groups;
    }
