 ...
 */
@SuppressWarnings({
        "LocalCanBeFinal", "unchecked", "StringBufferMayBeStringBuilder", "StringConcatenationInsideStringBufferAppend",
        "IndexOfReplaceableByContains", "UnusedAssignment", "ConstantConditions", "PointlessBooleanExpression", "UnusedParameters"})
public class YUI implements Compressor {

    private final StringBuilder srcsb = new StringBuilder();

    public YUI(final ContextFactory factory, final OptionGroup config) {
    }
