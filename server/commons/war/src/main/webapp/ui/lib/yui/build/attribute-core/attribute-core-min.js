...
YUI.add("attribute-core", function (e, t) {
    ...
    e.State = function () {
        this.data = {}
    }, e.State.prototype = {add: function (e, t, n) {
        var r = this.data[e];
    ...
    b.INVALID_VALUE = {}, y = b.INVALID_VALUE, b._ATTR_CFG = [o, s, l, c, h, a, u, p, v], b.protectAttrs = function (t) {
        ...
        return t
    }, b.prototype = {_initAttrHost: function (t, n, r) {
        this._state = new e.State, this._initAttrs(t, n, r)
    }, addAttr: function (e, t, n) {
        var r = this, i = r._state, s = i.data, o = s[e], u, a, f;
        t = t || {}, p in t && (n = t[p]), a = i.get(e, d);
        if (n && !a)o || (o = s[e] = {}), o.lazy = t, o.added = !0; else if (!a || t.isLazyAdd)f = c in t, f ? (u = t.value, t.value = undefined) : o && c in o && (t.value = o.value), t.added = !0, t.initializing = !0, s[e] = t, f && r.set(e, u), t.initializing = !1;
        return r
        ...
        var u = !0, a = this._state, l = this._stateProxy, c, h, p, d, v, m, g;
        return t.indexOf(i) !== -1 && (p = t, d = t.split(i), t = d.shift()), c = a.data[t] || {}, c.lazy && (c = c.lazy, this._addLazyAttr(t, c)), h = c.value === undefined, l && t in l && !c._bypassProxy && (h = !1), m = c.writeOnce, g = c.initializing, !h && !o && (m && (u = !1), c.readOnly && (u = !1)), !g && !o && m === f && (u = !1), u && (h || (v = this.get(t)), d && (r = n.setValue(e.clone(v), d, r), r === undefined && (u = !1)), u && (!this._fireAttrChange || g ? this._setAttrVal(t, p, v, r, s, c) : this._fireAttrChange(t, p, v, r, s, c))), this
    }, _getAttr: function (e) {
        var t = e, r = this._tCfgs, s, o, u, a, f;
        return e.indexOf(i) !== -1 && (s = e.split(i), e = s.shift()), r && r[e] && (f = {}, f[e] = r[e], delete r[e], this._addAttrs(f, this._tVals)), a = this._state.data[e] || {}, a.lazy && (a = a.lazy, this._addLazyAttr(e, a)), u = this._getStateVal(e, a), o = a.getter, o && !o.call && (o = this[o]), u = o ? o.call(this, u, t) : u, u = s ? n.getValue(u, s) : u, u
        ...
        if (!e)return null;
        t = {};
        for (u in e)e.hasOwnProperty(u) && (u.indexOf(i) !== -1 ? (r = u.split(i), s = r.shift(), n = n || {}, o = n[s] = n[s] || [], o[o.length] = {path: r, value: e[u]}) : t[u] = e[u]);
