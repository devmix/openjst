 ...
 */
public final class ClientConnectionObj extends AbstractEntityModel {
    ...
    public ClientConnectionObj(final long id, final long accountId, final String authId, final String name,
