...
YUI.add(OJST.ns.views.page.dashboard.connections.Accounts, function (Y) {
    "use strict";
     ...
     */
    OJST.ui.views.page.dashboard.connections.Accounts = Y.Base.create('viewsPageDashboardConnectionsAccounts', OJST.ui.views.page.dashboard.Abstract, [], {

        /** @override */
        createForm: function () {
            var list = new OJST.ui.models.connection.AccountList({ persistentId: 'pageDashboardConnectionsAccounts' });
    ...
    OJST.ns.models.connection.Account,
