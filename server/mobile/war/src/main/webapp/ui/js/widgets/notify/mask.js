...
YUI.add(OJST.ns.widgets.notify.Mask, function (Y) {
    "use strict";
     ...
     * @extends Y.Base
     */
    OJST.ui.widgets.notify.Mask = Y.Base.create('widgets-notify-mask', Y.Base, [], {
        ...
        show: function () {
            ...
            this._maskNode = Y.Node.create('<div></div>').addClass('yui3-widgets-notify-mask');
            ...
            this._messageNode = Y.Node.create(
                '<div class="yui3-widgets-notify-mask-message"><div class="icon"></div><span class="message">' + this.get('message') + '</span></div>');
