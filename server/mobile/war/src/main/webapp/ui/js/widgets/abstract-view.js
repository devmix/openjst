...
YUI.add(OJST.modules.widgets.AbstractView, function (Y) {
    "use strict";
     ...
     * @extends Y.View
     */
    OJST.ui.widgets.AbstractView = Y.Base.create('widgetsAbstractView', Y.View, [], {

        containerTemplate: '<div style="overflow:hidden; position:relative;"/>',
        ...
        delegate: function (type, fn, spec, context, args) {
            var contentBox = this.get(OJST.STATIC.CONTAINER);
