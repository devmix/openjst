 ...
 */
public class MockActionWithResources2And4 implements Action {

    private static final long serialVersionUID = -498547204418610679L;

    private final Set<Resource> resources;

    public MockActionWithResources2And4() {
        this.resources = new HashSet<Resource>(Arrays.asList(new MockResource(2), new MockResource(4)));
    }
