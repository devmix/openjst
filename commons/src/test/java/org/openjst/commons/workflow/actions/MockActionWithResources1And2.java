 ...
 */
public final class MockActionWithResources1And2 implements Action {

    private static final long serialVersionUID = -498547204418610679L;

    private final Set<Resource> resources;

    public MockActionWithResources1And2() {
        this.resources = new HashSet<Resource>(Arrays.asList(new MockResource(1), new MockResource(2)));
    }
