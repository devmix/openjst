...
package vendor.java.util.concurrent;

import vendor.java.util.Deque;
...
/**
 * A {@link vendor.java.util.Deque} that additionally supports blocking operations that wait
