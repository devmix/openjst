...
//import org.openjst.protocols.basic.types.ProtocolBasicConstants;
//
...
//                    System.nanoTime(), System.currentTimeMillis(), CLIENT, RPCMessageFormat.XML, new byte[]{0}));
//        }
//    }
//
...
//        floods = 100;
//
//        client = new Client(HOST, ProtocolBasicConstants.DEFAULT_CLIENT_PORT);
//
...
//                    e.printStackTrace();
//                }
//                client.connect(PacketsFactory.newAuthClientRequestPacket(
